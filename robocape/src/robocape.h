...
#define PID_FILE "/var/run/robocape.pid"
#define PWM_FREQ 500
...
//INCLUDED FOR UM ROBOCAPE
int simple_get_encoder_pos(int ch);
int simple_set_encoder_pos(int ch, int value);
...
//int simple_adc_init(); 
//int simple_adc_read_raw(uint8_t ch);
//float simple_adc_read_volts(uint8_t ch);
...
#define CONFIG_DIRECTORY "/etc/roboticscape/"
#define GYRO_CAL_FILE   "gyro.cal"
#define MAG_CAL_FILE    "mag.cal"
#define IMU_INTERRUPT_PIN 27  //gpio3.21 P9.25
